...
export function SeedMedallion({
  ...
  return (
    <span
      ...
      className={`inline-flex items-center justify-center rounded-full bg-[conic-gradient(from_220deg,#e9c56a,#f7efd9_20%,#d4a94a_45%,#9c7527_60%,#e9c56a_85%)] font-bold text-fairway-950 ring-1 ring-gold-600/60 shadow-[inset_0_1px_1px_rgb(255_255_255/0.65),inset_0_-1px_1px_rgb(66_48_18/0.35),0_1px_2px_rgb(66_48_18/0.3)] ${
